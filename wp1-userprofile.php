...
function wpg1_user_profile_fields($user)
{
    ...
    <h3><?php _e('Google +1 Profile', 'wpg1'); ?></h3>
    <table class="form-table">
        ...
        <td>
            ...
            <span class="description"><?php printf(__('URL of your Google+ or (normal) Google profile. E.g. %s', 'wpg1'), 'https://plus.google.com/u/1/100912127446274756364/posts'); ?></span>
        </td>
        </tr>
    </table>
